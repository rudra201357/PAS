...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows === 1) {
        ...
        if ($row['password'] === $password) {
            ...
            $update = "UPDATE admins SET islogin = 1 , lastlogin = current_timestamp  WHERE email = '$email'";
  ...
  <div class="wrapper">
    <form action="" method="post">
      ...
      <div class="remember-forgot">
        ...
        <a href="forgetadmin.php">Forgot Password?</a>
      </div>

      <button type="submit" class="btn">Login</button>
      <div class="register-link">
        <p>Newly Join? <a href="adminregister.html">Admin Register</a></p>
      </div>
    </form>
  </div>
</body>
